...
class UnicodeTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.texto_entrada = criar_text_area(is_read_only=False, placeholder="Digite o texto aqui...", altura_minima=200)
        layout.addWidget(self.texto_entrada)
        layout_botoes = QHBoxLayout()
        self.btn_converter = criar_botao("Converter", self.converter_para_unicode, altura_minima=32)
        ...
        self.texto_saida = criar_text_area(is_read_only=True)
